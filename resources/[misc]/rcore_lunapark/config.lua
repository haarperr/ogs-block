...
Config.Text.COASTER_NO_MONEY    = 'You haven\'t got enough money, you need $0.'
Config.Text.COASTER_ROW_FULL    = 'Row full'
Config.Text.COASTER_GET_ON      = '~INPUT_CONTEXT~ Get on'
...
Config.Text.WHEEL_GET_ON     = '~INPUT_CONTEXT~ Get on'
...
Config.Text.FREEFALL_GET_ON     = '~INPUT_CONTEXT~ Get on'
