...
Citizen.CreateThread(function()
    exports["caue-keybinds"]:registerKeyMapping("", "Police", "Vehicle Megaphone", "+caue-police:vehicle-megaphone", "-caue-police:vehicle-megaphone")
    RegisterCommand('+caue-police:vehicle-megaphone', megaphoneUp, false)
    RegisterCommand('-caue-police:vehicle-megaphone', megaphoneDown, false)
