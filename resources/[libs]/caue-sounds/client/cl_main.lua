...
AddEventHandler("InteractSound_CL:PlayWithinDistanceOfCoords", function(maxDistance, soundFile, soundVolume, coords, pTransactionType)
    local lCoords = GetEntityCoords(PlayerPedId())
...
AddEventHandler("InteractSound_CL:PlayFlash", function(soundFile, soundVolume, time, hold, pTransactionType)
    SendNUIMessage({
        transactionType   = pTransactionType or "playSoundFlash",
        transactionFile   = soundFile,
        transactionVolume = soundVolume,
...
RegisterNetEvent("interactsound:toggle:stop")
AddEventHandler("interactsound:toggle:stop", function(soundFile)
    SendNUIMessage({
