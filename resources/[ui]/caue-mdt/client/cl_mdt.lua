...
function EnableGUI(enable)
    ...
    if enable then
        ...
        SendNUIMessage({type = "UpdatePoliceRoster", data = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTUejrdw63gWdOjhpmD4GxJ7o1gSBA9YIi7HoBdBxiknR2Xllh8kFrS2g-WSbQRxqepGXB74Q1kAeW-/pubhtml?widget=true&amp;headers=false%22%3E"})
